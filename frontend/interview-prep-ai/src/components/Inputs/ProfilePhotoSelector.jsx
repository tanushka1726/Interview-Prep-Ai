...
const ProfilePhotoSelector = ({setImage ,image , preview , setPreview}) => {
  ...
  <div className="flex justify-center mb-6">
    ...
    {!image? (
        ...
        <button 
        type='button'
        className='w-8 h-8 flex items-center justify-center bg-red-500 text-white rounded-full absolute -bottom-1 -right-0 cursor-pointer'
