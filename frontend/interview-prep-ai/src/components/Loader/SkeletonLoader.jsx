...
const SkeletonLoader = () => {
  return (
    <>
    <div role='status' class="animate-pluse space-y-4 max-w-3xl">
        ...
        <div class="animate-pulse space-y-4 max-w-3xl mt-10">
         ...
         <div class="space-y-2">
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded p-4 sapce-y-2">
                <div class="h-2.5 bg-gray-300 rounded w-3/4"></div>
